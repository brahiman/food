                                    ...
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-5">
                                                ...
                                                <img
                                                    src="{{ (!empty($profilData->photo)) ? asset('upload/admin_img/'.$profilData->photo) : asset('upload/default.jpg') }}"
                                                    alt="image de profil"
                            ...
                            <form action="{{route('admin.profile.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div>
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Nom complet</label>
